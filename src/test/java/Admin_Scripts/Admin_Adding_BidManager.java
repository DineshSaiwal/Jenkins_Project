...
public class Admin_Adding_BidManager extends Base_Class {
...
ExtentTest test;
	...
	void Add_Bid_Manager_Test() throws Exception{
		...
		test = extent.createTest("Admin Adding Bid Manager Test").assignAuthor("Dinesh_Saiwal").assignDevice(browserName).assignCategory("Smoke");
