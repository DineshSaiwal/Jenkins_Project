...
String pass2 = "Abcd.12345";
	...
	@Test
	void Team_Member_Change_Password() throws Exception {
		Change_Password_Page pg = new Change_Password_Page(driver);
		test = extent.createTest("Team Member Change Password").assignAuthor("Dinesh_Saiwal").assignDevice(browserName).assignCategory("Smoke");
