...
public class Updating_TeamMember extends Base_Class {

ExtentTest test;
	
	@Test
	void Update_TeamMember_Test() throws Exception{
		
		
		Updating_BidManager_Page pg = new Updating_BidManager_Page(driver);
		test = extent.createTest("Update Team Member Test").assignAuthor("Dinesh_Saiwal").assignDevice(browserName).assignCategory("Smoke");
