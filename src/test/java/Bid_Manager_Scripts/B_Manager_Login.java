...
public class B_Manager_Login extends Base_Class{
	...
	void B_Manager_Login_Test() throws InterruptedException {
		...
		test = extent.createTest("Bid Manager Login Test").assignAuthor("Dinesh_Saiwal").assignDevice(browserName).assignCategory("Smoke");
		test.info(MarkupHelper.createLabel("Test Case Executed On { "+ browserName +" } Browser", ExtentColor.BLUE));
		
 		 try {pg.Bid_Manager_mail();
