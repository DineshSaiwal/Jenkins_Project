...
public class Active_Client_Page {
...
//	}
	...
	@FindBy(xpath = "//div[contains(text(),'Active')]") private WebElement ClickActive;
	public void ClickActive()  {
		wait.until(ExpectedConditions.visibilityOf(ClickActive));
		wait.until(ExpectedConditions.elementToBeClickable(ClickActive)).click();
	...
	public Active_Client_Page(WebDriver driver) {
